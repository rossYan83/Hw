...
var gamekey = document.querySelector(".game__key");
var userkey = document.querySelector(".user__Key");
var gameScore = document.querySelector(".game__score");
var game = document.querySelector("#game");
var currentKeyIndex = 0;
gamekey.textContent = "\u041D\u0430\u0436\u043C\u0456\u0442\u044C \u043A\u043B\u0430\u0432\u0456\u0448\u0443 - ".concat(keys[currentKeyIndex]);
window.addEventListener("keydown", function (event) {
  var formatingKey = event.key.toUpperCase();
  userkey.textContent = "\u041D\u0430\u0442\u0438\u0441\u043D\u0443\u0442\u0430 \u043A\u043B\u0430\u0432\u0456\u0448\u0430 - ".concat(formatingKey);
  if (keys[currentKeyIndex] == formatingKey) {
    currentKeyIndex++;
    gamekey.textContent = "\u041D\u0430\u0436\u043C\u0456\u0442\u044C \u043A\u043B\u0430\u0432\u0456\u0448\u0443 - ".concat(keys[currentKeyIndex]);
    gameScore.textContent = "\u041D\u0430\u0442\u0438\u0441\u043D\u0443\u0442\u043E ".concat(currentKeyIndex, "/10");
    PNotify.success({
      title: "Success!",
      delay: 700
    });
